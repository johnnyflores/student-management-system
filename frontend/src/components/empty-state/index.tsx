...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-75 w-full ${className}`}
    >
      {Icon && (
      ...
      <div className="h-1 w-16 bg-linear-to-r from-slate-200 to-slate-300 rounded-full" />
    </div>
  );
};
